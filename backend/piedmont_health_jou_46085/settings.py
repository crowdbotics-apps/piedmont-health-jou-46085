"""
Django settings for piedmont_health_jou_46085 project.
...
ROOT_URLCONF = 'piedmont_health_jou_46085.urls'
...
WSGI_APPLICATION = 'piedmont_health_jou_46085.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "piedmont_health_jou_46085 API",
    "DESCRIPTION": "API documentation for piedmont_health_jou_46085 App",
    "VERSION": "v1",
}
